# 2026-05-29 20:01:27 by RouterOS 7.22
...
set [ find default-name=ether2 ] disable-running-check=no name="ROUTER 1"
set [ find default-name=ether3 ] disable-running-check=no name="ROUTER 2"
...
/ip address
add address=10.10.10.1/30 interface="ROUTER 2" network=10.10.10.0
add address=10.10.20.1/30 interface="ROUTER 1" network=10.10.20.0
/ip dhcp-client
...
add area=BACKBONE disabled=no interfaces="ROUTER 1"
add area=BACKBONE disabled=no interfaces="ROUTER 2"
/system identity
